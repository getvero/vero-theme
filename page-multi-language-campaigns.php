...
<section id="multi-language-hero" class="hero border-bottom">
  <div class="inner center-text">
    ...
    <p>Send multiple language variations inside a single campaign. That's it, no fancy stuff.</p>
  ...
  <div class="inner full-width halfs">
    <div class="left">
      ...
      <ul class="steps unstyled-list">
        ...
        <li class="step"><span class="number">4</span><p class="step-title"><strong>There is no fourth step! Launch the campaign and the right variation will be sent to the right user when your email is sent.</strong></p></li>
      </ul>
    </div>
    <div class="right">
