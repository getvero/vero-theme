...
<section id="logos" class="logos">
  <div class="inner xlarge-inner flush-top">
    ...
    <div class="border-light border-radius-10 bg-white grid grid-halfs">
      ...
      <blockquote>
        <p>I’m in the midst of transitioning over to Vero for this reason. All the things I liked about Drip, plus their email workflows and templating engine can pull data directly from my app’s API. Game changer for me.</p>
      </blockquote>
