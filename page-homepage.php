  ...
  <div class="inner large-inner flush-bottom">
    <div class="content">
     ...
     <form action="https://app.getvero.com/pre_signups" method='post' class="horizontal-form">
      ...
      <p class="mini light faded">In order to provide our service to you, we store the personal information you provide to us. By creating a trial account with Vero you agree to our <a href="/privacy">Privacy Notice</a> and <a href="/terms-of-service">Terms of Service</a>.</p>
    </div>
