...
function custom_load_custom_style_sheet() {
  ...
  if ( is_front_page() || is_page('capterra') || is_page('data-management') || is_page('customer-engagement') || is_page('vero-segment') || is_page('vero-stitch') || is_page('drag-and-drop') || is_page('careers') ) {
