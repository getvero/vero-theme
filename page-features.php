...
<section class="features-hero bg-gray-lighter">
  ...
  <div class="inner tiny-inner flush-bottom center-text">
    <span class="d-inline-block atomic semi-bold font-gray-dark bottom-margin-sm xs-bottom-margin-lg">Features</span>
    ...
    <div class="flex flex-column xs-flex-row items-center justify-center">
      ...
      <a class="btn btn--secondary btn-large btn-outline typeform-share link" id="talk_to_us" data-mode="popup" href="https://getvero.typeform.com/to/d9wZ4V" target="_blank">Talk to us</a>
    </div>
  </div>
