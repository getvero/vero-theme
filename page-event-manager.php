...
<section id="event-manager-event-schema" class="double-padding">
  <div class="inner large-inner center-text flush-bottom flush-top">
    ...
    <img class="center-text  d-block responsive-image small-cover-image-150" src="/wp-content/themes/vero/assets/images/landing-pages/event-manager/event-hero.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/event-manager/event-hero@2x.png 2x"  alt="Confidently send emails using real-time customer data">
  </div>
</section>
<section id="event-manager-add-event" class="feature-section double-padding">
  <div class="inner halfs medium-inner left-padding-large right-padding-large flush-bottom">
    ...
    <div class="right secondary">
      <img class="small-responsive-image hide-on-mobile" src="/wp-content/themes/vero/assets/images/landing-pages/event-manager/event-add.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/event-manager/event-add@2x.png 2x" alt="Design email campaigns with placeholder events">
    </div>
  </div>
</section>
<section id="event-manager-test-event" class="feature-section double-padding">
  <div class="inner halfs medium-inner small-reverse left-padding-large right-padding-large flush-bottom flush-top">
    <div class="left right-text">
      <img class="pull-right small-responsive-image right-padding-medium hide-on-mobile" src="/wp-content/themes/vero/assets/images/landing-pages/event-manager/event-test.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/event-manager/event-test@2x.png 2x" alt="Test and debug automated emails">
    </div>
    <div class="right">
