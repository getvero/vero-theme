...
<section id="event-manager-heading">
  <div class="inner small-inner center-text bottom-padding-medium">
    ...
    <h1 class="bottom-margin-small biggie">Confidently send emails with real-time customer data</h1>
...
<section id="event-manager-event-schema" class="double-padding">
  <div class="inner large-inner center-text flush-bottom flush-top">
    ...
    <img src="/wp-content/themes/vero/assets/images/landing-pages/event-manager/eventschema.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/event-manager/eventschema@2x.png 2x" class="center-text display-block responsive-image small-cover-image-150">
  </div>
</section>
