...
<section class="bg-dark-blue-lighter double-padding">
  ...
  <div class="inner border-bottom">
    <ul class="feature-list unstyled-list grid grid-thirds">
      ...
      <li class="stack-xs center-text">
        <svg class="align-middle" width="300" height="144" xmlns="http://www.w3.org/2000/svg"><g transform="translate(82 8)" fill="none" fill-rule="evenodd"><rect stroke="#1B2E5B" stroke-width="2" fill="#FFF" x="19" y="1" width="98" height="126" rx="8"/><rect stroke="#E1E1E1" fill="#FFF" x="35.5" y="69.5" width="65" height="43" rx="8"/><rect stroke="#E1E1E1" fill="#FFF" x="35.5" y="15.5" width="65" height="43" rx="8"/><g transform="translate(66 66)"><rect stroke="#1B2E5B" stroke-width="2" fill="#FFF" x="1" y="1" width="68" height="48" rx="8"/><rect fill="#F1F1F1" x="44" y="18" width="16" height="2" rx="1"/><rect fill="#F1F1F1" x="44" y="24" width="12" height="2" rx="1"/><rect fill="#F1F1F1" x="44" y="30" width="16" height="2" rx="1"/><g transform="translate(8 10)" fill="#FFC111"><path fill-opacity=".4" d="M15 24.909l-4.635 4.357-1.19-6.25-6.31.8 2.711-5.754L0 15l5.576-3.062-2.711-5.755 6.31.8 1.19-6.249L15 5.091 19.635.734l1.19 6.25 6.31-.8-2.711 5.754L30 15l-5.576 3.062 2.711 5.755-6.31-.8-1.19 6.249z"/><circle cx="15" cy="15" r="8"/></g></g><g transform="translate(0 12)"><rect stroke="#1B2E5B" stroke-width="2" fill="#FFF" x="1" y="1" width="68" height="48" rx="8"/><rect fill="#F1F1F1" x="38" y="18" width="22" height="2" rx="1"/><rect fill="#F1F1F1" x="38" y="24" width="18" height="2" rx="1"/><rect fill="#F1F1F1" x="38" y="30" width="22" height="2" rx="1"/><g transform="translate(10 13)" fill="#F15242"><circle cx="10" cy="6" r="6"/><path d="M4 14h12a4 4 0 014 4v6H0v-6a4 4 0 014-4z"/></g></g></g></svg>
