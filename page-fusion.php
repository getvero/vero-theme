...
<section id="external-attributes-hero" class="border-bottom-light">
  <div class="inner center-text flush-bottom">
    ...
    <div class="hero-image center-text top-margin-medium">
      <img class="responsive-image" src="/wp-content/themes/vero/assets/images/landing-pages/external-attributes/fusion-hero.svg" alt="emails that can talk to APIs ">
    </div>
  </div>
</section>
<section class="double-padding" id="external-attributes-howitworks">
  <div class="inner center-text gradient-border-bottom">
    ...
    <img class="top-margin-medium responsive-image" src="/wp-content/themes/vero/assets/images/landing-pages/external-attributes/fusion-api-diagram.svg" alt="load data from its source">
  ...
  <div class="inner center-text">
    ...
    <ul class="feature-list unstyled-list grid grid-thirds-small sm-center-text top-margin-medium">
      <li class="center-text">
        <img class="center-text top-margin-small" src="/wp-content/themes/vero/assets/images/landing-pages/external-attributes/fusion-recommendations.svg" alt="Recommendations">
      ...
      <li class="center-text">
        <img class="center-text top-margin-small" src="/wp-content/themes/vero/assets/images/landing-pages/external-attributes/fusion-charts.svg" alt="Dynamic data and charts">
      ...
      <li class="center-text">
        <img class="center-text top-margin-small" src="/wp-content/themes/vero/assets/images/landing-pages/external-attributes/fusion-delights.svg" alt="Delightful details">
...
<section id="external-attributes-scale" class="double-padding border-bottom-light">
  <div class="inner center-text flush-bottom">
    ...
    <img class="d-block responsive-image" src="/wp-content/themes/vero/assets/images/landing-pages/external-attributes/fusion-scale.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/external-attributes/fusion-scale@2x.png 2x" alt="Built to scale">
  </div>
</section>
