...
<section id="reports-hero-image" class="double-padding">
  <div class="inner large-inner center-text flush-bottom flush-top">
    <img src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-hero.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-hero@2x.png 2x" class="center-text d-block responsive-image small-cover-image-200" alt="Track the true performance ofyour email campaigns">
  </div>
</section>
<section id="reports-hero-features" class="double-padding">
  <div class="inner large-inner top-padding-large bottom-padding-large">
    ...
    <ul class="feature-list left-align unstyled-list flex flex-wrap justify-between halfs">
      <li>
        <img class="right-margin-small" src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-results.svg" alt="Monitor the overall results for key email campaign metrics">
        <div class="right">
          <p class="medium regular no-top-margin">Monitor the overall results for key email campaign metrics</p>
        </div>
      </li>
      <li>
        <img src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-day.svg" alt="Chart and export day-by-day metrics for all your campaigns">
        <div class="right">
          <p class="medium regular no-top-margin">Chart and export day-by-day metrics for all your campaigns</p>
        </div>
      </li>
      <li>
        <img class="right-margin-small" src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-series.svg" alt="Understand how each email within a series drives different results">
        <div class="right">
          <p class="medium regular no-top-margin">Understand how each email within a series drives different results</p>
        </div>
      </li>
      <li>
        <img class="right-margin-small" src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-review.svg" alt="Review results from one campaign to the next, ensuring consistency and stability">
        <div class="right">
...
<section id="reports-hero-ui-features" class="feature-section double-padding">
  <div class="inner halfs medium-inner left-padding-large right-padding-large flush-top">
    <div class="left center-text">
      <img src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-content-breakdown.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-content-breakdown@2x.png 2x" class="bottom-margin-small small-responsive-image" alt="Compare the results of A/B tests and different language variations.">
      <p class="medium regular">Compare the results of A/B tests and different language variations.</p>
    </div>
    <div class="right center-text">
      <img src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-links.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-links@2x.png 2x" class="small-responsive-image bottom-margin-small" alt="See exactly which links in your emails are getting the most traction.">
...
<section id="reports-webhooks" class="double-padding dark-box-flat">
  ...
  <div class="inner small-inner center-text flush-top flush-bottom">
    <img src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-webhooks.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-webhooks@2x.png 2x" class="center-text top-margin-medium bottom-margin-medium responsive-image" alt="Access the insights important to your business">
...
<section id="report-webhook-data" class="dark-box-flat">
  <div class="inner medium-inner center-text">
    ...
    <img src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-data.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-data@2x.png 2x" class="bottom-margin-small small-responsive-image top-margin-large" alt="Send a webhook for all of the data that originates from a Vero campaign">
  </div>
  <div class="inner medium-inner flush-bottom">
    ...
    <div class="center-text top-margin-medium">
      <img src="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-third-party-tools.png" srcset="/wp-content/themes/vero/assets/images/landing-pages/reporting/report-third-party-tools@2x.png 2x" class="center-text responsive-image align-middle" alt="Generate insights from a complete view of your customer data">
    </div>
  </div>
</section>
