...
<section class="bg-offwhite">
  <div class="inner large-inner center-text">
    <div class="flex flex-column">
      <div class="order-1 xs-order-0 xs-bottom-margin-md">
      ...
      <div class="order-0 xs-order-1 bottom-margin-md xs-no-bottom-margin">
        <h2 class="chunk bottom-margin-xxs xs-bottom-margin-xs">One workflow for email and push messages</h2>
