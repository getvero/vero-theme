  ...
  <div class="inner large-inner stack-md">
    ...
    <div class="flex flex-wrap">
      <div class="col-main stack-lg">
        <div class="stack-sm">
          <h1 class="biggie">When I Work is a market leader in hourly workforce management that provides businesses a fully-integrated scheduling, time tracking, and team messaging solution</h1>
        ...
        <div class="stack-sm">
          ...
          <ul class="stack-xs">
            <li>
              <p>nability to access customer interaction history, monitor engagement and understand the impact of communications on the customer lifecycle.</p>
            </li>
            <li>
