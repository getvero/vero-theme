      ...
      <div class="flex">
        <div class="stack-xs">
          <div class="flex items-center">
            <svg class="align-middle border-radius-1 right-margin-xxs" width="26" height="26" xmlns="http://www.w3.org/2000/svg"><defs/><g fill="none" fill-rule="evenodd"><path d="M-330.172-1020.172l519.344 519.344a4 4 0 010 5.656L-330.172 24.172a4 4 0 01-5.656 0l-519.344-519.344a4 4 0 010-5.656l519.344-519.344a4 4 0 015.656 0z" stroke="#E1E1E1"/><g transform="translate(-48 -48)"><rect stroke="#01B2D0" fill="#E5F7FA" x=".5" y=".5" width="1015" height="247" rx="8"/><path fill="#EE5758" d="M48 48h26v26H48z"/><g fill="#FFF" fill-rule="nonzero"><path d="M56.027 62.418v-2.95c0-.15.122-.27.27-.27h3.33c.151 0 .272.122.272.27v2.95a.27.27 0 01-.271.27h-3.33a.27.27 0 01-.271-.27zM59.9 64.57v3.023a.27.27 0 01-.269.27l-3.33.03a.271.271 0 01-.274-.27v-3.055c0-.15.122-.27.27-.27h3.33c.151.002.273.124.273.272zM66.294 54.293a.27.27 0 00-.27-.27h-9.727a.27.27 0 00-.27.27v3.022c0 .15.122.27.27.27H66.022a.27.27 0 00.27-.27v-3.022h.002zM66.294 59.468a.27.27 0 00-.27-.27H61.886a.27.27 0 00-.27.27v2.95c0 .15.122.27.27.27h4.135a.27.27 0 00.27-.27v-2.95h.002z"/></g></g></g></svg>
  ...
  <div class="inner medium-inner">
    <div class="w-sidebar w-sidebar--md items-center">
      ...
      <div class="col-aside relative center-text lg-right-text">
        <img class="align-middle responsive-image" src="/wp-content/themes/vero/assets/dist/images/integrations/freshpaint/meaningful-insights.svg" alt="Meaningful and actionable insights">
      </div>
    </div>
  </div>
</section>
